...
(function() {
  var ERROR_MSG, EU_COUNTRIES_CODES, SERVICE_ERRORS, exports, getReadableErrorMsg, headers, http, parseSoapResponse, parsedUrl, serviceUrl, soapBodyTemplate, url,
  ...
  module.exports = exports = function(params, callback) {
    var options, ref, ref1, req, requesterXml, xml;
    if ((ref = params.countryCode, indexOf.call(EU_COUNTRIES_CODES, ref) < 0) || !((ref1 = params.vatNumber) != null ? ref1.length : void 0)) {
    ...
    if (params.requesterCountryCode || params.requesterVatNumber) {
      requesterXml = '<tns1:requesterCountryCode>' + params.requesterCountryCode + '</tns1:requesterCountryCode>' + '<tns1:requesterVatNumber>' + params.requesterVatNumber + '</tns1:requesterVatNumber>';
    ...
    req = http.request(options, function(res) {
      ...
      return res.on('end', function() {
        ...
        if ((ref2 = data.faultString) != null ? ref2.length : void 0) {
